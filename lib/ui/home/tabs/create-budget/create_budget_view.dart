...
import 'create_budget_controller.dart';

class CreateBudgetView extends GetView<CreateBudgetController> {
  CreateBudgetView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xfff5f5f5),//Colors.grey.withOpacity(0.0),
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Row(
                        children: [Icon(Icons.search)],//AntDesign.search1
                      )
                    ],
                  ),
                ],
            ...
            child: Row(
                children: List.generate(categories.length, (index) {
                  return GestureDetector(
                    onTap: () {
                      print("active categori is $index");
                      // setState(() {
